...
:mod:`mesher` objects and automating common tasks.

**Objects**

* :func:`vis.myv.prisms`
* :func:`vis.myv.tesseroids`

**Misc objects**

* :func:`vis.myv.outline`
* :func:`vis.myv.axes`
* :func:`vis.myv.wall_north`
* :func:`vis.myv.wall_south`
* :func:`vis.myv.wall_east`
* :func:`vis.myv.wall_west`
* :func:`vis.myv.wall_top`
* :func:`vis.myv.wall_bottom`
* :func:`vis.myv.earth`
* :func:`vis.myv.core`
* :func:`vis.myv.continents`
* :func:`vis.myv.meridians`
* :func:`vis.myv.parallels`
...
def tesseroids(tesseroids, prop=None, style='surface', opacity=1, edges=True,
    ...
    * tesseroids : list of :class:`mesher.Tesseroid`
        The tesseroids
    * prop : str or None
